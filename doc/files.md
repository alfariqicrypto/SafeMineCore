...
* safeminemore.conf: contains configuration settings for safeminemored or safeminemore-qt
* safeminemored.pid: stores the process id of safeminemored while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by safeminemored or safeminemore-qt
