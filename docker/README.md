...
official/supported Docker Images found at https://hub.docker.com/r/safeminemore/safeminemored/
...
**NOTE: Please update the image description at https://hub.docker.com/r/safeminemore/safeminemored-develop/ when changing the above text**