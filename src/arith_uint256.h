...
#ifndef SAFEMINEMORE_ARITH_UINT256_H
#define SAFEMINEMORE_ARITH_UINT256_H
...
public:
     ...
     *
     * Safeminemore only uses this "compact" format for encoding difficulty
...
#endif // SAFEMINEMORE_ARITH_UINT256_H
