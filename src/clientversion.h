...
#error Client version information missing: version is not defined by safeminemore-config.h or in any other way
#endif
...
/**
 * safeminemored-res.rc includes this file, but it cannot cope with real c++ code.
