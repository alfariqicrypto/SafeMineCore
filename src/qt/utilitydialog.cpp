    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  safeminemore-qt [command-line options]                     \n";
...
All the Safeminemore in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 SM2R, 0.01 SM2R, 0.1 SM2R, 1 SM2R and 10 SM2R -- sort of like the paper money you use every day.</li> \
