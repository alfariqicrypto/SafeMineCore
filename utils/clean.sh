...
rm -f src/config/safeminemore-config.h
...
rm -rf test_bitcoin.coverage/ safeminemore-gtest.coverage/ total.coverage/
...
clean_exe src/safeminemore-cli
clean_exe src/safeminemored
clean_exe src/safeminemore-gtest
clean_exe src/safeminemore-tx
clean_exe src/test/test_safeminemore
clean_exe src/test/test_safeminemore_fuzzy
...
clean_dep . src/config/safeminemore-config.h.in
